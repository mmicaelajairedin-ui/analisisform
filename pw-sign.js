...
(function(g){
  ...
  function sigInner(p, m, variant){
    ...
    return '<table cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;"><tr>'
      ...
      +   '<div style="font-family:Arial,Helvetica,sans-serif;font-size:10px;font-weight:600;letter-spacing:2.5px;color:'+roleCol+';text-transform:uppercase;margin-top:4px;">Pathway Career Coach</div>'
