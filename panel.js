...
function sbGet(table,filter){
  return fetch(SB+'/rest/v1/'+table+'?'+filter+'&order=created_at.desc',{headers:{'apikey':KEY,'Authorization':'Bearer '+KEY}}).then(function(r){return r.json();});
}
